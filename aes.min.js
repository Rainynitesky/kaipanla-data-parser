...
window.localStorage = {
    ...
    setItem: function(name, value){
        console.log("storage_name", name, value)
        this[name] = value;
    }
}
canvas_get = {
    getContext: function(tag){
        console.log("canvas", tag)
        if (tag==='webgl2'){
            return true
        }
    }
...
document = {
    getElementsByTagName: function(tag){
        console.log('get_tag', tag)
        if(tag==='head'){
            return [{}]
        }
    },
    createElement: function(tag){
        console.log('create_tag', tag)
        if(tag==='div'){
            return {"onwheel": true}
        }else if(tag==='canvas'){
            return canvas_get
...
// 原始js代码
var TOKEN_SERVER_TIME = 1759419993.107;
!function(n, t, r, e) {
    !function() {
        var a = r[0]
          , u = n[0]
